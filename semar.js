...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/freefire/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/freefire/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/grupwa/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/grupwa/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/youtube/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/youtube/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/simontok/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/simontok/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/mobile-legend/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/mobile-legend/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://shirai.my.id/cishop/codashop/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://shirai.my.id/cishop/codashop/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
